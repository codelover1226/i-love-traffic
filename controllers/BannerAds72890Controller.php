...
class BannerAds72890Controller extends Controller
{
    private $model;
    public function __construct()
    {
        $this->model = new BannerAds72890Model();
}
    ...
    public function getBannerAd()
    {
        ...
        if (!empty($bannerData)) {
            echo "<div class='bannerFrameWeb-728-90'>
                    <a href=\"banner-click-728-90.php?id=" . $bannerData["id"] . "\" target=\"_blank\">
                        <img src=\"" . $bannerData["image_link"] . "\" height=\"90\" width=\"728\" />
                    </a>
            ...
            echo "<a href=\"index.php\"><img src=\"images/728x90.jpg\" height=\"90\" width=\"728\" /></a>";
        }
    }
