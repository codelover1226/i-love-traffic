...
class BannerAds160600Controller extends Controller
{
    private $model;
    public function __construct()
    {
        $this->model = new BannerAds160600Model();
}
    ...
    {
        return $this->pagination(30, $this->totalBannerAds(), "web-banner-ads-160-600.php");
    }
    ...
    public function getBannerAd()
    {
        ...
        if (!empty($bannerData)) {
            echo "<div class='bannerFrameWeb-160-600'>
                    <a href=\"banner-click-160-600.php?id=" . $bannerData["id"] . "\" target=\"_blank\">
                        <img src=\"" . $bannerData["image_link"] . "\" height=\"600\" width=\"160\" />
                    </a>
            ...
            echo "<a href=\"index.php\"><img src=\"images/160x600.jpg\" height=\"600\" width=\"160\" /></a>";
        }
    }
    ...
    {
        return $this->pagination(30, $this->totalUserBannerAds($username), "web-banners.php");
    }
