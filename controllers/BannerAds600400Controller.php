...
class BannerAds600400Controller extends Controller
{
    private $model;
    public function __construct()
    {
        $this->model = new BannerAds600400Model();
}
    ...
    {
        return $this->pagination(30, $this->totalBannerAds(), "web-banner-ads-600-400.php");
    }
    ...
    public function getBannerAd()
    {
        ...
        if (!empty($bannerData)) {
            echo "<div class='bannerFrameWeb-600-400'>
                    <a href=\"banner-click-600-400.php?id=" . $bannerData["id"] . "\" target=\"_blank\">
                        <img src=\"" . $bannerData["image_link"] . "\" height=\"400\" width=\"600\" />
                    </a>
            ...
            echo "<a href=\"index.php\"><img src=\"images/600x400.jpg\" height=\"400\" width=\"600\" /></a>";
        }
    }
