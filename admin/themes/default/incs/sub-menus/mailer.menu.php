...
<li class="menu nav-item">
    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'mailer'}" @click="activeDropdown === 'mailer' ? activeDropdown = null : activeDropdown = 'mailer'">
        <div class="flex items-center">
            ...
            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Mailer</span>
        </div>
        <div class="rtl:rotate-180" :class="{'!rotate-90' : activeDropdown === 'mailer'}">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        </div>
    </button>
    <ul x-cloak x-show="activeDropdown === 'mailer'" x-collapse class="sub-menu text-gray-500">
        <li>
            <a href="email-list.php">Emails</a>
        </li>
        <li>
            <a href="email-queue.php">Email Queue</a>
        </li>
        <li>
            <a href="mailer-settings.php">Mailer Settings</a>
        </li>
        <li>
            <a href="email-clicks.php">Email Clicks</a>
        </li>
        <li>
            <a href="email-reports.php">Email Reports</a>
        </li>
        <li>
            <a href="email-credits.php">Credit Packages</a>
        </li>
        <li>
            <a href="random-rewards.php">Random Rewards Settings</a>
        </li>
    </ul>
</li>