...
$flag = $adminController->sendSingleMail();
            ...
            <div class="mb-5">
                <form class="forms-sample" action="" method="POST">
                    <div class="form-group">
                        <label for="noticeContent">To</label>
                        <input type="email" class="form-input" name="email_to" placeholder="Enter recipient's email address" value="<?= isset($_GET['email']) ? $_GET['email'] : '' ?>">
                    </div>
                    <div class="form-group">
