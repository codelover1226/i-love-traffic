...
$flag = $otherSettingsController->updateLoginCreditConvesationRate();
$otherSettingsData = $otherSettingsController->getLoginAdCreditConversation();
            ...
            <div class="mb-5">
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-input" name="login_credit_conversation" value="<?= $otherSettingsData['settings_value'] ?>" placeholder="Conversation rate">
