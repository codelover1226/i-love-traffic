...
$flag = $productsController->deleteProduct();
$products = $productsController->productList();
        ...
        <div class="panel">
            <div class="mb-5">
                <div class="table-responsive">
                            ...
                            <?php if (!empty($products)) : ?>
                                <?php foreach ($products as $product) : ?>
                                    <tr>
                                        ...
                                        <td><a href="../check-out.php?type=combo&id=<?= $product['id'] ?>">check-out.php?type=combo&id=<?= $product["id"] ?></a></td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                                ...
                                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0">
                                                    <li><a href="products.php?action=edit&id=<?= $product['id'] ?>">Edit</a> </li>
                                                    <li><a href="products.php?delete=<?= $product['id'] ?>&token=<?= $adminController->getAdminCSRFToken() ?>">Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <?= $productsController->productsPagination() ?>
                </div>
            </div>
        </div>
    </div>
