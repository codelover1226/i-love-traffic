...
$promotionalemailsController = new PromotionalEmailsController();
$flag = $promotionalemailsController->deleteEmail();
$emailList = $promotionalemailsController->getEmails();
    ...
    <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-1">
        <div class="panel">
            <div class="relative inline-flex align-middle">
                <a href="promotional-emails.php?action=add"><button type="button" class="btn btn-dark ltr:rounded-r-none rtl:rounded-l-none">Add Email</button></a>
            </div>
            <br><br>
            <div class="mb-5">
                        ...
                        <tbody>
                            <?php if (!empty($emailList)) : ?>
                                <?php foreach ($emailList as $emailDetails) : ?>
                                    <tr>
                                        <td><?= base64_decode($emailDetails["email_subject"]) ?></td>
                                        <td class="text-center">
                                            <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                                ...
                                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0">
                                                    <li><a href="promotional-emails.php?edit=<?= $emailDetails['id'] ?>">Edit</a> </li>
                                                    <li><a href="promotional-emails.php?delete=<?= $emailDetails['id'] ?>&token=<?= $adminController->getAdminCSRFToken() ?>">Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
