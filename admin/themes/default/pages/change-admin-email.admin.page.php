...
$flag = $adminController->changeAdminEmail();
        ...
        <div class="panel">
            <div class="mb-5">
                <form action="" method="POST">
                    ...
                    <input id="email" name="email" type="email" placeholder="Enter your email" value="<?= $adminDetails['email'] ?>" class="form-input" />

                    <label for="c_password">Current Password</label>
                    <input id="c_password" name="password" type="password" placeholder="Enter your password" class="form-input" />
