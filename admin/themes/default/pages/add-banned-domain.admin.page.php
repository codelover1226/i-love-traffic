...
$flag = $bannedDomainController->addNewDomain();
...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    ...
    <ul class="flex space-x-2 rtl:space-x-reverse">
        ...
        <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
        <a href="banned-domains.php" class="text-primary hover:underline">Banned Domains</a>
        </li>
        <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
            <span><?= $title ?></span>
        </li>
            ...
            <div class="mb-5">
                <form action="" method="POST">
                    <div class="form-group">
                        <label for="noticeContent">Domain</label>
                        <input type="text" class="form-input" name="domain" placeholder="Enter domain you want to ban. Don't enter http or https.">
