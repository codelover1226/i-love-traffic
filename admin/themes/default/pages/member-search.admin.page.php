...
if (isset($_GET["username"])) {
    $memberList = $membersController->searchMemberByUsername();
} else if (isset($_GET["email"])) {
    $memberList = $membersController->searchMemberByEmail();
}
...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    ...
    <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-1">
        <div class="panel">
            ...
            <br><br>
            <form action="members.php?action=search" method="GET">
            ...
            <div class="mb-5">
                <div class="table-responsive">
                    ...
                    <?php else : ?>
                        <?php if (isset($_GET["username"]) && !empty($_GET["username"]) || isset($_GET["email"]) && !empty($_GET["email"])) : ?>
                            <div class="alert alert-danger">Couldn't find any member.</div>
                        <?php endif; ?>
                    <?php endif; ?>
                    <?= $membersController->membersPagination() ?>
                </div>
            </div>
        </div>
    </div>
