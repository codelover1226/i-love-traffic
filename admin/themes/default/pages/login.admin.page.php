...
require_once "themes/default/incs/login-header.theme.php";
?>
...
<div class="main-container min-h-screen text-black dark:text-white-dark">
  <div x-data="auth">
    <div class="absolute inset-0">
      <img src="themes/default/assets/images/auth/bg-gradient.png" alt="image" class="h-full w-full object-cover" />
    </div>
    ...
    <div class="relative flex min-h-screen items-center justify-center bg-[url(../images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
      <img src="themes/default/assets/images/auth/coming-soon-object1.png" alt="image" class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
      <img src="themes/default/assets/images/auth/coming-soon-object2.png" alt="image" class="absolute left-24 top-0 h-40 md:left-[30%]" />
      <img src="themes/default/assets/images/auth/coming-soon-object3.png" alt="image" class="absolute right-0 top-0 h-[300px]" />
      <img src="themes/default/assets/images/auth/polygon-object.svg" alt="image" class="absolute bottom-0 end-[28%]" />
      <div class="relative w-full max-w-[870px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)]">
        <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
          <div class="mx-auto w-full max-w-[440px]">
            ...
            <?php if (isset($flag) && isset($flag["success"]) && $flag["success"] == false) : ?>
              <script>
                document.addEventListener('DOMContentLoaded', function() {
                  showAlertWithMessage(`<?= addslashes($flag["message"]) ?>`);
                });
              </script>
            <?php endif; ?>

            <form class="space-y-5 dark:text-white" method="POST" action="">
              <input type="hidden" name="admin_login_csrf" value="<?= $_SESSION['admin_login_csrf'] ?>">
              <div>
                <label for="username">Username</label>
                <div class="relative text-white-dark">
                  <input id="username" name="username" type="text" placeholder="Enter your username" class="form-input ps-10 placeholder:text-white-dark" />
              ...
              <div>
                ...
                <div class="relative text-white-dark">
                  <input id="Password" name="password" type="password" placeholder="Enter Your Password" class="form-input ps-10 placeholder:text-white-dark" />
                  <span class="absolute start-4 top-1/2 -translate-y-1/2">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            <div class="text-center dark:text-white">
              <br>
              Powered by
              <a href="https://i-lovetraffic.online" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white" target="_blank">i-LoveTraffic</a>
            </div>
          </div>
        </div>
      </div>
...
<?php require_once "themes/default/incs/login-footer.theme.php"; ?>