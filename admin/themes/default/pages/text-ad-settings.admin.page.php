...
$flag = $otherSettingsController->updateTextAdCreditConvesationRate();
$otherSettingsData = $otherSettingsController->getTextAdCreditConversation();
...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    ...
    <ul class="flex space-x-2 rtl:space-x-reverse">
        ...
        <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
            <a href="text-ads.php" class="text-primary hover:underline">Text Ads</a>
        </li>
        <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
            <span><?= $title ?></span>
        </li>
            ...
            <div class="mb-5">
                <form class="forms-sample" action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-input" name="text_ad_credit_conversation" value="<?= $otherSettingsData['settings_value'] ?>" placeholder="Conversation rate">
