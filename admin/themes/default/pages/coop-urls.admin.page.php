...
if (isset($_GET["activate"])) {
    $flag = $coopUrlsController->activateAd();
}
if (isset($_GET["pause"])) {
    $flag = $coopUrlsController->pauseAd();
}
if (isset($_GET["ban"])) {
    $flag = $coopUrlsController->banAd();
}
$coopUrlsList = $coopUrlsController->coopurlsList();
$adminController->adminCSRFTokenGen();
?>
<?php if (isset($_GET["details"]) && !empty($_GET["details"])) :?>
<?php $linkDetails = $coopUrlsController->getCoopUrlDetails($_GET["details"]); ?>
    <div class="animate__animated p-6" :class="[$store.app.animation]">
        ...
        <?php if (empty($linkDetails)) : ?>
            <div class="container">
                <div class="alert alert-danger">Sorry ! Couldn't find the coop link.</div>
            </div>
        <?php endif ?>
        <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
            <div class="panel">
                <div class="mb-5">
                    <h2 style="font-size:20px; font-weight:600;">Visitors Country</h2>
                    <div class="table-responsive">
                        <table>
                            <thead>
                                <td>Country</td>
                                <td style="width:50px">Visits</td>
                            </thead>
                            <tbody>
                                <tr></tr>
                            </tbody>
            ...
            <div class="panel">
                <div class="mb-5">
                    <h2 style="font-size:20px; font-weight:600;">Visitors Origin</h2>
                    <div class="table-responsive">
                        <table>
                            <thead>
                                <td>Origin</td>
                ...
                <div class="mb-5">
                    <div class="table-responsive">
                        <table>
                            ...
                            <tbody>
                                <?php if (!empty($coopUrlsList)) : ?>
                                    <?php foreach ($coopUrlsList as $adData) : ?>
                                        <tr>
                                            <td><?= $adData["username"] ?></td>
                                            ...
                                            <td>
                                                <a href="web-coop-urls.php?details=<?= $adData['id'] ?>">
                                            ...
                                            <td class="text-center">
                                                <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                                    ...
                                                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0">
                                                        <?php if ($adData["status"] != 1) : ?>
                                                            <li><a class="dropdown-item" href="web-coop-urls.php?activate=<?= $adData['id'] ?>&token=<?= $adminController->getAdminCSRFToken() ?>">Pend Ad</a></li>
                                                        <?php endif; ?>
                                                        <?php if ($adData["status"] != 2) : ?>
                                                            <li><a class="dropdown-item" href="web-coop-urls.php?pause=<?= $adData['id'] ?>&token=<?= $adminController->getAdminCSRFToken() ?>">Approve Ad</a></li>
                                                        <?php endif; ?>
                                                        <?php if ($adData["status"] != 3) : ?>
                                                            <li><a class="dropdown-item" href="web-coop-urls.php?ban=<?= $adData['id'] ?>&token=<?= $adminController->getAdminCSRFToken() ?>">Ban Ad</a></li>
                                                        <?php endif; ?>
                                                    </ul>
                                                </div>
                                            </td>
                        ...
                        <?= $coopUrlsController->coopUrlsPgination() ?>
                    </div>
                </div>
            </div>
        </div>
