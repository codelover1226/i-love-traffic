...
$flag = $withdrawalRequestsController->markAsPaid();
$withdrawalRequests = $withdrawalRequestsController->pendingWithdrawalRequestsList();
...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    ...
    <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-1">
        <div class="panel">
        <a href="withdrawal-requests.php?action=paid"><button type="button" class="btn btn-primary">Paid Requests</button></a><br>
            <div class="mb-5">
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                                        ...
                                        <td class="text-center">
                                            <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                                ...
                                                <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0">
                                                    <li> <a href="withdrawal-requests.php?paid=<?= $withdrawalRequest['id'] ?>&token=<?= $adminController->getAdminCSRFToken() ?>">Mark as Paid</a> </li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <?php else : ?>
                                <br>
                                <div class="alert alert-danger">No pending withdrawal requests</div>
                            <?php endif; ?>
                        </tbody>
                    </table>
                    <?= $withdrawalRequestsController->withdrawalRequestsPagination() ?>
                </div>
            </div>
        </div>
    </div>
