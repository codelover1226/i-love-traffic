...
$flag = $bannerPublisherController->updateSettings();
            ...
            <div class="mb-5">
                <form action="" method="POST">
                    <div class="form-group">
                        <label for="noticeContent">Credit Per Banner Surfing</label>
                        <input type="text" class="form-input" name="banner_publisher" placeholder="Enter credit amount" value="<?= $settings['settings_value'] ?>">
