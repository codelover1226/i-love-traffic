...
$flag = $splashPageController->addNewSplashPage();
...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    ...
    <ul class="flex space-x-2 rtl:space-x-reverse">
        ...
        <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
            <a href="splash-pages.php" class="text-primary hover:underline">Splash Pages</a>
        </li>
        <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
            <span><?= $title ?></span>
        </li>
            ...
            <div class="mb-5">
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="splash_page_name" placeholder="Enter a name for your splash page">
                        <input type="hidden" name="admin_csrf_token" value="<?= $adminController->getAdminCSRFToken() ?>">
                    </div>
                    <div class="form-group">
                        <label for="noticeContent">Splash Page Content (You can use HTML/CSS/JS)</label>
                        <textarea class="form-input" rows="30" name="splash_page_content" placeholder="Enter your page content"></textarea>
                    </div>
