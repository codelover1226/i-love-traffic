...
$flag = $specialOfferPagesController->addNewPage();
            ...
            <div class="mb-5">
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="page_title" placeholder="Page title" />
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-input" rows="15" name="page_content" placeholder="Page content"></textarea>
                    </div>
