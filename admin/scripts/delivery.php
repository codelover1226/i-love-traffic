<?php
	...
	*/
	...
	require_once (dirname(__FILE__)."/../../load_classes.php");
	...
	$db->query("
		...
		".(isset($develEmailsWhere) ? $develEmailsWhere : null)."
		order by
			is_immediate desc,
			priority asc,
			date_queued asc
		".($mailsPerMin['settings_value'] ? " LIMIT 0, ".$mailsPerMin['settings_value'] : "")."
	");
