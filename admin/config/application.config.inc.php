<?php
	...
	define("API_KEY", "asfKkj3=m2345z");  // The secret key to access Emailqueue via API. Change it to a random string of your choice.

	define("FRONTEND_USER", "admin"); // The user name for the frontend. Change it to your desired user.
	define("FRONTEND_PASSWORD", "admin"); // The password for the frontend. Change it to a strong password of your choice.
	...
	define("SMTP_SERVER", "server.i-lovetraffic.online"); // The IP of the SMTP server
	define("SMTP_PORT", 465); // The port of the SMTP server
	define("SMTP_IS_AUTHENTICATION", true); // True to use SMTP server Authentication
	define("SMTP_AUTHENTICATION_USERNAME", "send@i-lovetraffic.online");
	define("SMTP_AUTHENTICATION_PASSWORD", "WGrr--Y0Q78X");
