			...
			$retr = "
                <div class=block>
                    <div class=block_title>Status</div>
		  			<div class=pairs>
                        <div class=pair style='display: none;'><div class=key>Environment</div><div class=value>".(IS_DEVEL_ENVIRONMENT ? "⚙️Development" : "✅Production")."</div></div>
                        ...
                        <div class=pair><div class=key>Maximum delivers per min</div><div class=value>".number_format($mailsPerMin['settings_value'], 0, ".", ",")."</div></div>
