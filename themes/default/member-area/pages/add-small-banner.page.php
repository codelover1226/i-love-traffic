...
$flag = $smallBannerAdController->addUserBannerAd($username);
                ...
                <div class="col-lg-12">
                    <div class="card border border-primary">
                        <div class="card-header bg-transparent border-primary">
                            <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>Add New 125x125 Banner</h5>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                            <form action="" method="POST" accept-charset="utf-8">
                                ...
                                <input type="url" name="image_link" class="form-control" placeholder="Your 125x125 banner link">
                        </div><br>
                        <div class="form-group">
                            <label>Ad Link</label>
