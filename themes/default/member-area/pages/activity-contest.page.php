        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <?php if ($contestInfo["contest_info"]["status"] != 1) : ?>
                    <div class="alert alert-danger">Activity contest is not available now. Please check back later.</div>
                <?php else : ?>
                    <?php if ($contestEndTime < time()) : ?>
                        <div class="alert alert-danger">Activity contest has been ended.</div>
                    <?php endif; ?>
                    <div class="row">
                        <div class="col-lg-6">
