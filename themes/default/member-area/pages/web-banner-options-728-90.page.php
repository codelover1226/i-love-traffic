...
if (isset($_POST["image_link"])) {
    $flag = $bannerAd72890Controller->updateUserAd($username, $id);
} else if (isset($_POST["credits"])) {
    $flag = $bannerAd72890Controller->addUserAdCredits($username, $userInfo, $id);
} else if (isset($_POST["remove_credits"])) {
    $flag = $bannerAd72890Controller->removeBannerAdCredits($username, $id);
}
$bannerAdDetails = $bannerAd72890Controller->getbannerAdDetails($id);
