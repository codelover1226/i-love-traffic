...
$flag = $textAdController->addUserAd($username);
                ...
                <div class="col-lg-12">
                    <div class="card border border-primary">
                        <div class="card-header bg-transparent border-primary">
                            <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>Add New Text Ad</h5>
                        </div>
                        <div class="card-body">
                            <p class="card-text">
                            <form action="" method="POST" accept-charset="utf-8">
                                ...
                                <input type="text" name="ad_title" class="form-control" placeholder="Ad Title (Max 20 Characters)">
                        </div><br>
                        <div class="form-group">
                            <label>Ad Text</label>
                            <input type="text" name="ad_text" class="form-control" placeholder="Ad Text {Max 40 Characters)">
                        </div><br>
                        <div class="form-group">
