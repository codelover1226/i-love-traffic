                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <?php foreach ($receivedMailList as $index => $receivedMailDetails) : 
                            $profileSection = '<table cellpadding="0" cellspacing="0" width="600" border="0" style="min-width: 600px; background-position-x: right; background:url(images/1.png); width: 100%;" dir="ltr" class="st-Copy st-Copy--caption st-Width st-Width--mobile">
                                                    <tbody>
                                                        <tr>
                                                            <td height="156" width="252" valign="bottom" align="right" style="background-color: #f9f9f900; border: 0; border-collapse: collapse; margin: 0; padding: 0; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; font-size: 0; line-height: 0px; mso-line-height-rule: exactly; background-size: 100% 100%; border-top-left-radius: 5px;" class="Header-left Target"><img height="156" width="252" alt=""  style="display: block; border: 0; line-height: 100%; width: 100%;"> </td>
                                                            <td height="156" valign="center" align="center" style="background-color: #f9f9f900; border: 0; border-collapse: collapse; margin: 0; padding: 0; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; font-size: 0; line-height: 0px; mso-line-height-rule: exactly; background-size: 100% 100%; width: 96px !important;" class="Header-icon Target"><a rel="noopener" href="https://i-lovetraffic.online/index.php?referrer='.$receivedMailDetails['sender_username'].'" style="-webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; outline: 0; text-decoration: none;" target="blank"> <img height="156" width="96" alt="" src='.$membersController->gravatar($membersController->userInfoByUsername($receivedMailDetails['sender_username'])['email'] , $siteSettingsData['installation_url']).' style="display: block; border: 0; height: 96px; border-radius: 100%"> </a></td>
                                                            <td height="156" width="252" valign="bottom" align="left" style="background-color: #f9f9f900; border: 0; border-collapse: collapse; margin: 0; padding: 0; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; font-size: 0; line-height: 0px; mso-line-height-rule: exactly; background-size: 100% 100%; border-top-right-radius: 5px;" class="Header-right Target"><img height="156" width="252" alt=""  style="display: block; border: 0; line-height: 100%; width: 100%;"> </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
