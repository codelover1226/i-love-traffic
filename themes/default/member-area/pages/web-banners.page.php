...
if (isset($_GET["pause"])) {
    $flag = $bannerAdController->pauseUserAd($username, $_GET["pause"]);
} else if (isset($_GET["activate"])) {
    $flag = $bannerAdController->activateUserAd($username, $_GET["activate"]);
} else if (isset($_GET["delete"])) {
    $flag = $bannerAdController->deleteUserAd($username, $_GET["delete"]);
}
$membersController->generateUserCSRFToken();
$bannerAdsList = $bannerAdController->userBannerAdsList($username);
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                ...
                <div class="col-lg-12">
                    <div class="card border border-primary">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= $bannerAdController->adStatus()[$adData["status"] - 1] ?>
                                </td>
                                <td>
                                    <a href="web-banners.php?options=<?= $adData['id'] ?>">
                    ...
                    <?php $bannerAdController->userBannerAdsPagination($username) ?>
                </div>
