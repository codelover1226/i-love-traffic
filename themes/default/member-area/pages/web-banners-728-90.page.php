...
if (isset($_GET["pause"])) {
    $flag = $bannerAd72890Controller->pauseUserAd($username, $_GET["pause"]);
} else if (isset($_GET["activate"])) {
    $flag = $bannerAd72890Controller->activateUserAd($username, $_GET["activate"]);
} else if (isset($_GET["delete"])) {
    $flag = $bannerAd72890Controller->deleteUserAd($username, $_GET["delete"]);
}
$membersController->generateUserCSRFToken();
$bannerAdsList = $bannerAd72890Controller->userBannerAdsList($username);
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                ...
                <div class="col-lg-12">
                            ...
                            <?php if (!empty($bannerAdsList)) : ?>
                                <?php foreach ($bannerAdsList as $adData) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= $bannerAd72890Controller->adStatus()[$adData["status"] - 1] ?>
                                        </td>
                                        <td>
                                            <a href="web-banners-728-90.php?options=<?= $adData['id'] ?>">
                    ...
                    <?php $bannerAd72890Controller->userBannerAdsPagination($username) ?>
                </div>
