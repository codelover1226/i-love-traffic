...
if (isset($_POST["image_link"])) {
    $flag = $bannerAd600400Controller->updateUserAd($username, $id);
} else if (isset($_POST["credits"])) {
    $flag = $bannerAd600400Controller->addUserAdCredits($username, $userInfo, $id);
} else if (isset($_POST["remove_credits"])) {
    $flag = $bannerAd600400Controller->removeBannerAdCredits($username, $id);
}
$bannerAdDetails = $bannerAd600400Controller->getbannerAdDetails($id);
