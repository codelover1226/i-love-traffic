...
if (isset($_POST["image_link"])) {
    $flag = $coopUrlsController->updateUserAd($username, $id);
} else if (isset($_POST["credits"])) {
    $flag = $coopUrlsController->addUserAdCredits($username, $userInfo, $id);
} else if (isset($_POST["remove_credits"])) {
    $flag = $coopUrlsController->removeCoopUrlCredits($username, $id);
}
$coopUrlDetails = $coopUrlsController->getcoopUrlDetails($id);
if ($coopUrlDetails["username"] != $username) {
    $adAccess = false;
    $flag = array(
        "success" => false,
        "message" => "Couldn't find the coop ad."
    );
} else {
    $adAccess = true;
}
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <?php if (isset($flag) && isset($flag["success"])) : ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <?php if ($adAccess && !empty($coopUrlDetails)) : ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card border border-primary">
                                <div class="card-header bg-transparent border-primary">
                                    <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow me-3"></i>Edit Coop Url</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>Coop Url</label>
                                        <input type="url" name="ad_link" class="form-control" placeholder="Your target link" value="<?= $coopUrlDetails['ad_link'] ?>">
                                    </div><br>
                                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="card border border-danger">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class=" form-group">
                                        <label>Credits</label>
                                        <input type="number" name="remove_credits" class="form-control" placeholder="Credits amount" value="<?= $coopUrlDetails['credits'] ?>">
                                </div><br>
                                <div class="form-group">
