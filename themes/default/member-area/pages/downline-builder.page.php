...
$uplink = $userInfo["referrer"];
if (!empty($uplink)) {
    $downlinePrograms = $downlineBuilderController->getUserDownlinePrograms($userInfo["referrer"]);
}
if (empty($uplink) || empty($downlinePrograms)) {
    $downlinePrograms = $downlineBuilderController->getAdminDownlinePrograms();
    $uplink = "";
}
?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-9">
                ...
                <?php endif; ?>
                <?php if (!empty($uplink)) : ?>
                    <div class="alert alert-info">The following programs are recommended by your sponsor <strong><?= $uplink ?></strong>. If you have find
                        any to be of an inappropriate nature. Please contact Admin.</div>
                <?php endif; ?>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
