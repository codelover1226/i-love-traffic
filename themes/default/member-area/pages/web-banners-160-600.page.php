...
if (isset($_GET["pause"])) {
    $flag = $bannerAd160600Controller->pauseUserAd($username, $_GET["pause"]);
} else if (isset($_GET["activate"])) {
    $flag = $bannerAd160600Controller->activateUserAd($username, $_GET["activate"]);
} else if (isset($_GET["delete"])) {
    $flag = $bannerAd160600Controller->deleteUserAd($username, $_GET["delete"]);
}
$membersController->generateUserCSRFToken();
$bannerAdsList = $bannerAd160600Controller->userBannerAdsList($username);
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                ...
                <div class="col-lg-12">
                            ...
                            <?php if (!empty($bannerAdsList)) : ?>
                                <?php foreach ($bannerAdsList as $adData) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= $bannerAd160600Controller->adStatus()[$adData["status"] - 1] ?>
                                        </td>
                                        <td>
                                            <a href="web-banners-160-600.php?options=<?= $adData['id'] ?>">
                    ...
                    <?php $bannerAd160600Controller->userBannerAdsPagination($username) ?>
