...
<li class="nav-item">
    ...
    <div class="collapse menu-dropdown" id="sidebar728">
        <ul class="nav nav-sm flex-column">
            <li class="nav-item">
                <a href="web-banners-728-90.php" class="nav-link" data-key="t-calendar">Banners</a>
            </li>
            <li class="nav-item">
                <a href="web-banners-728-90.php?action=add" class="nav-link" data-key="t-chat">Add Banner</a>
            </li>
        </ul>
    </div>
</li>