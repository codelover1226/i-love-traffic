...
<li class="nav-item">
    ...
    <div class="collapse menu-dropdown" id="sidebarChatGPT">
        <ul class="nav nav-sm flex-column">
            <li class="nav-item">
                <a href="chat-gpt-prompt.php" class="nav-link" data-key="t-calendar">Generate Emails</a>
            </li>
            <li class="nav-item">
                <a href="chat-gpt-prompt-history.php" class="nav-link" data-key="t-chat">History</a>
            </li>
        </ul>
    </div>
</li>